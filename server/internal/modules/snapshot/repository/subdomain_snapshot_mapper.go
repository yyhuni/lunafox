...
func subdomainSnapshotModelToDomain(item *model.SubdomainSnapshot) *snapshotdomain.SubdomainSnapshot {
	...
	return &snapshotdomain.SubdomainSnapshot{ID: item.ID, ScanID: item.ScanID, DNSName: item.DNSName, CreatedAt: timeutil.ToUTC(item.CreatedAt)}
}
...
func subdomainSnapshotDomainToModel(item *snapshotdomain.SubdomainSnapshot) *model.SubdomainSnapshot {
	...
	return &model.SubdomainSnapshot{ID: item.ID, ScanID: item.ScanID, DNSName: item.DNSName, CreatedAt: timeutil.ToUTC(item.CreatedAt)}
}
