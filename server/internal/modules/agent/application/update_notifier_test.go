...
func (publisher *notifierPublisherStub) SendTaskCancel(int, int, int) {}

func (publisher *notifierPublisherStub) TrySendTaskCancel(int, int, int) bool { return true }
...
func TestUpdateNotifierDedupAndReset(t *testing.T) {
	...
	notifier.maybeSendUpdateRequired(1, "v1.0.1")
