...
func (service *ScanTaskFacade) UpdateStatus(ctx context.Context, agentID, taskID int, status string, failure *FailureDetail) error {
	err := service.runtimeService.UpdateStatus(ctx, agentID, taskID, status, failure)
	if err != nil {
