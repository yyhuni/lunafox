...
func runControlledGitOutput(ctx context.Context, output io.Writer, args ...string) error {
	...
	// Do not start a subprocess after its caller has already canceled the
	// operation; a fast command could otherwise exit successfully before the
	// cancellation branch observes the context.
