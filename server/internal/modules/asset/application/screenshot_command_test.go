...
func (stub *screenshotCommandStoreStub) BatchDelete(ids []int) (int64, error) {
...
func (stub *screenshotCommandStoreStub) BatchUpsert(items []assetdomain.Screenshot) (int64, error) {
...
func TestScreenshotCommandServiceBatchDeleteAndUpsert(t *testing.T) {
	...
	status := int16(200)
	affected, err := service.BatchUpsert(context.Background(), 1, &BatchUpsertScreenshotRequest{Screenshots: []ScreenshotItem{
...
func TestScreenshotCommandServiceTargetNotFound(t *testing.T) {
	...
	_, err := service.BatchUpsert(context.Background(), 9, &BatchUpsertScreenshotRequest{Screenshots: []ScreenshotItem{{URL: "https://a.com"}}})
