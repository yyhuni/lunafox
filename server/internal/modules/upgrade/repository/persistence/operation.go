...
type Operation struct {
	...
	ExecutionMode              string     `gorm:"column:execution_mode;size:32;not null;default:''"`
	WorkDisposition            string     `gorm:"column:work_disposition;size:32;not null;default:''"`
	PlanSummary                []byte     `gorm:"column:plan_summary;type:jsonb;not null"`
	PlanDigest                 string     `gorm:"column:plan_digest;size:71;not null;default:''"`
	BaselineDeploymentDigest   string     `gorm:"column:baseline_deployment_digest;size:71;not null;default:''"`
	ConfirmedDeploymentVersion string     `gorm:"column:confirmed_deployment_version;size:64;not null;default:''"`
