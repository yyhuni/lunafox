...
func snapshotScreenshotAssetRequestToApplication(req *snapshotapp.ScreenshotAssetUpsertRequest) *assetapp.BatchUpsertScreenshotRequest {
	if req == nil {
		return nil
	}
	...
	return &assetapp.BatchUpsertScreenshotRequest{Screenshots: items}
}
