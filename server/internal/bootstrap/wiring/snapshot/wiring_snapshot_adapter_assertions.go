...
var _ snapshotapp.SnapshotApplicationScanRefLookup = (*snapshotScanRefLookupAdapter)(nil)
var _ snapshotapp.MutableObservationMaterializationCoordinator = (*snapshotMaterializationCoordinator)(nil)
