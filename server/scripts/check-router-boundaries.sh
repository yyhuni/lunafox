...
expected_entries_for_module() {
	...
	agent)
		...
		;;
	asset)
		echo "RegisterAssetRoutes RegisterHealthRoutes RegisterSystemRoutes"
		;;
	blacklist)
		echo "RegisterBlacklistPolicyRoutes"
		;;
	catalog)
		echo "RegisterCatalogRoutes"
		;;
	fingerprint)
		echo "RegisterFingerprintRoutes"
		;;
	identity)
		echo "RegisterIdentityRoutes"
		;;
	loginvisual)
		echo "RegisterLoginVisualRoutes"
		;;
	notification)
		echo "RegisterNotificationRoutes"
		;;
	nucleipoc)
		echo "RegisterNucleiPOCRoutes"
		;;
	scan)
		echo "RegisterScanRoutes"
		;;
	scheduledscan)
		echo "RegisterScheduledScanRoutes"
		;;
	security)
