...
用法:
  RELEASE_VERSION=1.2.3 \
	...
	./scripts/ci/generate-release-manifest.sh --engine-ref-dir dist/engine-digests [--runtime-composition-sha256 <sha256:...>] [--output <path>] [--release-notes-file <path>] [--final-runtime-contract] [--verify-contract]
