...
[ "$(file_mode "$certificate_dir/fullchain.pem")" = 600 ] || fail "certificate mode is not 0600"
[ "$(file_mode "$certificate_dir/privkey.pem")" = 600 ] || fail "private key mode is not 0600"
