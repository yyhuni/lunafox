  ...
  const demos = [
    {
      ...
      description: "Visual-first layout focusing on quick identification and status overview. Best for small to medium number of workflows.",
      path: "scan/workflow/demo/card-grid",
      icon: <LayoutGrid className="h-8 w-8 text-primary" />,
      color: "bg-blue-500/10"
    },
    {
      title: "Design B: Data Table",
      description: "Information-dense layout for managing many workflows with sorting and filtering capabilities. Best for power users.",
      path: "scan/workflow/demo/table-list",
    ...
    },
    {
      ...
      path: "scan/workflow/demo/hybrid",
      icon: <IconLayoutColumns className="h-8 w-8 text-primary" />, 
      color: "bg-orange-500/10"
    },
    {
      title: "Design D: Feature Flow",
      description: "Conceptual layout visualizing workflows as processing pipelines. Best for understanding complex scan logic.",
      path: "scan/workflow/demo/feature-flow",
  ...
  return (
    <div className="container mx-auto py-10 max-w-5xl">
      <div className="mb-10 text-center">
        <h1 className="text-3xl font-bold tracking-tight mb-3">Scan Workflow Design Concepts</h1>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Exploring different UX patterns for managing scan workflow configurations. 
