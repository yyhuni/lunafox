...
const source = readFileSync(path.resolve(process.cwd(), "app/targets/[id]/endpoints/page.tsx"), "utf8")

describe("page contract", () => {
  it("preserves current source markers", () => {
    expect(source).toContain("export default async function TargetEndpointsPage")
