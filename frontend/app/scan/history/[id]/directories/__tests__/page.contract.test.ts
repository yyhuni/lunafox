...
const source = readFileSync(path.resolve(process.cwd(), "app/scan/history/[id]/directories/page.tsx"), "utf8")

describe("page contract", () => {
  it("preserves current source markers", () => {
    expect(source).toContain("export default async function ScanDirectoriesPage")
