...
const source = readFileSync(path.resolve(process.cwd(), "app/scan/history/[id]/endpoints/page.tsx"), "utf8")

describe("page contract", () => {
  it("preserves current source markers", () => {
    expect(source).toContain("export default async function ScanHistoryEndpointsPage")
    ...
    expect(source).toContain("from \"@/components/endpoints/endpoints-detail-view\"")
  })
