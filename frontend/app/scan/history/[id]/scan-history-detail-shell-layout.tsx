...
export const SCAN_HISTORY_DETAIL_SHELL_CLASS =
  `${COMPACT_FULL_PAGE_SHELL_CLASS} min-w-0 overflow-x-hidden`
export const SCAN_HISTORY_DETAIL_SHELL_HEADER_CLASS = `flex items-center gap-2 text-sm ${COMPACT_CONTENT_GUTTER_CLASS}`
export const SCAN_HISTORY_DETAIL_SHELL_PRIMARY_TABS_CLASS = `overflow-x-auto ${COMPACT_CONTENT_GUTTER_CLASS}`
export const SCAN_HISTORY_DETAIL_SHELL_SECONDARY_TABS_CLASS = `flex min-w-0 items-center overflow-x-auto ${COMPACT_CONTENT_GUTTER_CLASS}`
