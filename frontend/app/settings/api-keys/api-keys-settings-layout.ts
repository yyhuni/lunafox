...
export const API_KEYS_PROVIDER_DETAIL_CARD_CLASS =
  "flex min-h-0 flex-col gap-0 overflow-hidden py-0 lg:col-span-3"

export const API_KEYS_CARD_HEADER_CLASS = "border-b"

export const API_KEYS_PROVIDER_LIST_HEADER_CLASS =
  "h-10 grid-rows-1 items-center gap-0 border-b px-0 py-0 [.border-b]:pb-0"

export const API_KEYS_PROVIDER_SEARCH_INPUT_CLASS =
  "rounded-none border-0 bg-transparent shadow-none dark:bg-card focus-visible:border-0 focus-visible:ring-0 focus-visible:ring-offset-0"

export const API_KEYS_PROVIDER_SEARCH_ROW_CLASS = "min-w-0"

export const API_KEYS_PROVIDER_LIST_CONTENT_CLASS = "min-h-0 flex-1 overflow-auto px-0"

export const API_KEYS_PROVIDER_ROW_CLASS = "relative flex items-center border-b border-border last:border-b-0"

export const API_KEYS_PROVIDER_ROW_SELECTED_CLASS =
...
export const API_KEYS_PROVIDER_STATUS_SLOT_CLASS = "flex w-16 shrink-0 justify-end"
...
export const API_KEYS_CARD_FOOTER_ACTION_GROUP_CLASS = "flex flex-wrap items-center gap-2"

export const API_KEYS_FIELD_GROUP_CLASS = "space-y-2"

export const API_KEYS_PASSWORD_INPUT_ROW_CLASS = "flex gap-2"

export const API_KEYS_PASSWORD_INPUT_FIELD_SLOT_CLASS = "relative flex-1"

export const API_KEYS_PASSWORD_INPUT_CLASS = "pr-10"

export const API_KEYS_PASSWORD_COPY_ACTION_CLASS = "absolute right-1 top-1/2 -translate-y-1/2"
