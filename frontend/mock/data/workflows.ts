...
// User workflow templates (stored in database, editable)
...
export function getMockWorkflows(): ScanWorkflow[] {
  return mockWorkflows
}

export function getMockWorkflowById(id: number): ScanWorkflow | undefined {
