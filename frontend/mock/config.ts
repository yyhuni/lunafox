...
export const DEFAULT_MOCK_SCENARIO = 'happy'
export const MOCK_SCENARIO = process.env.NEXT_PUBLIC_MOCK_SCENARIO || DEFAULT_MOCK_SCENARIO
...
export function resolveMockScenarioFromEnv(): string {
