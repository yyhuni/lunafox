...
import { BulkAddUrlsDialogHeader, BulkAddUrlsFooter, BulkAddUrlsInput, } from "@/components/common/bulk-add-urls-dialog-sections";
 ...
 */
export function BulkAddUrlsDialog({ targetId, assetType, targetName, targetType, open: externalOpen, onOpenChange: externalOnOpenChange, onSuccess, }: BulkAddUrlsDialogProps) {
    ...
    const { open, handleOpenChange, inputText, validationResult, lineNumbersRef, textareaRef, mutation, handleInputChange, handleSubmit, handleTextareaScroll, lineCount, isFormValid, } = useBulkAddUrlsDialogState({
        targetId,
        assetType,
        targetName,
        targetType,
    ...
    return (<Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className={scrollableFormDialogContentClassName}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <BulkAddUrlsFooter tBulkAdd={tBulkAdd} tUrl={tUrl} isPending={mutation.isPending} isFormValid={isFormValid}/>
        </form>
      </DialogContent>
    </Dialog>);
}
