...
import {
  ...
  TerminalLoginHeader,
  TerminalMobilePanel,
} from "@/components/auth/terminal-login-sections"
...
export function TerminalLogin({
  ...
  const renderInputWithCursor = () => {
    ...
    return (
      <>
        ...
        <span className="animate-blink bg-primary inline-block min-w-[0.6em] text-primary-foreground">
          {cursorChar || "\u00A0"}
        </span>
  ...
  return (
    ...
    >
      ...
      {/* Terminal content */}
      <div className="font-mono min-h-[280px] p-4 text-sm">
