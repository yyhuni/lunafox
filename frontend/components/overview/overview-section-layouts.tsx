...
export const OVERVIEW_RUNTIME_SCAN_RECENT_META_CLASS = "grid min-w-0 flex-1 grid-cols-[minmax(0,1fr)_minmax(40px,0.35fr)_minmax(119px,1fr)] gap-x-2 sm:grid-cols-[minmax(0,1fr)_minmax(72px,0.6fr)_minmax(0,1fr)] sm:gap-x-4"
