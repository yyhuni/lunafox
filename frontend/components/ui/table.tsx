...
const TABLE_DENSE_ROW_CLASS = "h-10"
const TABLE_DENSE_CELL_RHYTHM_CLASS = "px-2 py-0.5"
const TABLE_DENSE_ROW_RHYTHM_HEIGHT_PX = 40
const TABLE_DENSE_ROW_ESTIMATED_HEIGHT_PX = 41
...
function TableRow({ className, ...props }: React.ComponentProps<"tr">) {
  return (
    <tr
      data-slot="table-row"
      className={cn(
        "border-b border-border bg-card transition-colors hover:bg-secondary active:bg-secondary/80 data-[state=selected]:bg-secondary/70",
        className
      )}
      {...props}
    />
