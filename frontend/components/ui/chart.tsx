        ...
        {payload
          ...
          .map((item, index) => {
            ...
            const indicatorOpacity =
              typeof item.payload?.fillOpacity === "number" ? item.payload.fillOpacity : undefined
                  ...
                  <>
                    {itemConfig?.icon ? (
                      ...
                      !hideIndicator && (
                        <div
                          className={cn(
                            "shrink-0 rounded-[calc(var(--radius)/2)] border-(--color-border) bg-(--color-bg)",
                            {
          ...
          return (
            ...
            >
              {itemConfig?.icon && !hideIcon ? (
                ...
                <div
                  className="h-2 rounded-[calc(var(--radius)/2)] shrink-0 w-2"
                  style={{
