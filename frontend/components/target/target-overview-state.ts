...
export function useTargetOverviewState({ targetId }: TargetOverviewStateOptions) {
    ...
    () => [
      {
        ...
        iconKey: "websites",
        code: "DAT-WEB",
        href: `/targets/${targetId}/websites/`,
      },
      {
        ...
        iconKey: "subdomains",
        code: "DAT-SUB",
        href: `/targets/${targetId}/subdomains/`,
      },
      {
        title: t("cards.ips"),
        value: summary.ips || 0,
        iconKey: "ips",
        code: "DAT-IP",
        href: `/targets/${targetId}/ip-addresses/`,
      },
      {
        title: t("cards.urls"),
        ...
        iconKey: "urls",
        code: "DAT-URL",
        href: `/targets/${targetId}/endpoints/`,
      },
      {
        ...
        iconKey: "directories",
        code: "DAT-DIR",
        href: `/targets/${targetId}/directories/`,
      },
      {
        ...
        iconKey: "screenshots",
        code: "DAT-SCR",
        href: `/targets/${targetId}/screenshots/`,
      },
    ],
    [summary, targetId, t]
  )
  ...
  const scheduledScans = React.useMemo(
    () => scheduledScansData?.scheduledScans || [],
    [scheduledScansData?.scheduledScans]
  )
  const totalScheduledScans = React.useMemo(
    () => scheduledScansData?.totalSize || 0,
    [scheduledScansData?.totalSize]
  )
