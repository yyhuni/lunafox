...
describe("app-shell-warmup contract", () => {
  it("owns protected app shell warmup through the real protected shell chrome", () => {
    ...
    expect(source).toContain("protectedAppShellContentStyle")
    expect(source).toContain("protectedAppShellScrollAreaClassName")
    expect(source).toContain("protectedAppShellScrollViewportClassName")
    ...
    expect(source).toContain("contentClassName={protectedAppShellContentFrameClassName}")
    expect(source).toContain("contentStyle={protectedAppShellContentStyle}")
    expect(source).toContain('type="always"')
    expect(source).toContain("viewportClassName={protectedAppShellScrollViewportClassName}")
