    ...
    const renderDiagram = async () => {
      ...
      try {
        ...
        const colorFromVar = (name: string, fallback: string) => {
          ...
          return resolveColor(`var(${name})`, fallback)
        }

        const background = colorFromVar("--background", "Canvas")
        const card = colorFromVar("--card", "Canvas")
        const foreground = colorFromVar("--foreground", "CanvasText")
        const mutedForeground = colorFromVar("--muted-foreground", "GrayText")
        const border = colorFromVar("--border", "GrayText")
