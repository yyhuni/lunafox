...
export function YamlEditor({
  ...
  return (
    <div className={cn("flex flex-col h-full", className)}>
      ...
      {yamlError && (
        <div className="bg-destructive/10 border-destructive/20 border-t flex gap-2 items-start p-2">
          <AlertCircle className="flex-shrink-0 h-3.5 mt-0.5 text-destructive w-3.5" />
