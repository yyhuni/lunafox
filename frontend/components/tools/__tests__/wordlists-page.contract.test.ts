...
describe("wordlists-page contract", () => {
  ...
  it("renders wordlists as accessible catalog cards that open a shared detail drawer", () => {
    ...
    expect(drawerSource).toContain('label={t("resourceName")}')
    expect(drawerSource).toContain("value={wordlist.name}")
    expect(drawerSource).toContain('copiedLabel={t("resourceNameCopied")}')
    expect(drawerSource).toContain("wordlist-resource-name-")
