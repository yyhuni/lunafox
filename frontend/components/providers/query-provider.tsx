...
type QueryClientGlobal = typeof globalThis & {
  __lunafoxQueryClient?: QueryClient
}
...
function getQueryClient() {
  ...
  const globalForQueryClient = globalThis as QueryClientGlobal
  globalForQueryClient.__lunafoxQueryClient ??= createQueryClient()
  return globalForQueryClient.__lunafoxQueryClient
}
