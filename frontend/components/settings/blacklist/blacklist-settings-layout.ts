...
export const BLACKLIST_RULE_GROUP_TABLE_CLASS = "overflow-hidden rounded-md border"

export const BLACKLIST_RULE_ROW_CLASS = "flex min-h-12 items-center border-b last:border-b-0"

export const BLACKLIST_RULE_ICON_CELL_CLASS =
  "flex h-12 w-12 shrink-0 items-center justify-center border-r text-muted-foreground"

export const BLACKLIST_RULE_VALUE_CELL_CLASS = "flex min-w-0 flex-1 items-center gap-3"

export const BLACKLIST_RULE_STATUS_CELL_CLASS = "flex w-8 shrink-0 items-center justify-center"
...
export const BLACKLIST_EDITOR_TITLE_GROUP_CLASS = "space-y-2"

export const BLACKLIST_EDITOR_EXAMPLES_ROW_CLASS = "flex flex-wrap items-center gap-2"

export const BLACKLIST_EDITOR_STATUS_SLOT_CLASS = "flex items-center gap-3"

export const BLACKLIST_EDITOR_CONTENT_CLASS = "flex min-h-0 flex-1 flex-col border-t px-0"

export const BLACKLIST_EDITOR_VIEWPORT_CLASS = "min-h-0 flex-1 rounded-none border-0 border-b"

export const BLACKLIST_EDITOR_NUMBERS_CLASS = "py-0"

export const BLACKLIST_EDITOR_TEXTAREA_CLASS = "py-0"
