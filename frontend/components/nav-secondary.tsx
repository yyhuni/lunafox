...
import { SidebarGroup, // Sidebar group
 ...
 */
export function NavSecondary({ items, ...props // Other properties passed to SidebarGroup
 }: {
    items: {
    ...
    return (<SidebarGroup {...props}>  {/* Pass all other properties */}
      ...
      <SidebarGroupContent>
        ...
        <SidebarMenu>
          ...
          {items.map((item) => (<SidebarMenuItem key={item.title}>
              {/* Navigation menu button, rendered as link using Base UI render */}
              <SidebarMenuButton render={<a href={item.url}/>}>              {/* Navigation link */}
