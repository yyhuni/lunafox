...
export const getOrganizationDeleteToastId = (id: number): string => `delete-organization-${id}`
export const ORGANIZATION_BATCH_DELETE_TOAST_ID = "batch-delete-organizations"
