...
export const getBulkInitiateScanSuccessCount = (
  data: BulkInitiateScanResponse,
  fallbackCount: number
): number => data.scans?.length || data.count || fallbackCount || 0
