...
describe("use-tools mutation", () => {
  ...
  it("创建工具成功时保留 loading/success 与失效范围", async () => {
    ...
    expect(toastMocks.dismiss).not.toHaveBeenCalledWith("create-tool")
    expect(toastMocks.success).toHaveBeenCalledWith(
      "toast.tool.create.success",
      undefined,
      "create-tool"
    )
  ...
  it("更新工具成功时保留 loading/success 与失效范围", async () => {
    ...
    expect(toastMocks.dismiss).not.toHaveBeenCalledWith("update-tool")
    expect(toastMocks.success).toHaveBeenCalledWith(
      "toast.tool.update.success",
      undefined,
      "update-tool"
    )
    expect(invalidateSpy).toHaveBeenCalledWith({
  ...
  it("删除工具成功时保留 loading/success 与失效范围", async () => {
    ...
    expect(toastMocks.dismiss).not.toHaveBeenCalledWith("delete-tool")
    expect(toastMocks.success).toHaveBeenCalledWith(
      "toast.tool.delete.success",
      undefined,
      "delete-tool"
    )
    expect(invalidateSpy).toHaveBeenCalledWith({
