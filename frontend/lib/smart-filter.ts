...
export function getTranslatedFields(
  ...
  return {
    ip: { key: "ip", label: t("fields.ip"), description: t("fields.ip") },
    port: { key: "port", label: t("fields.port"), description: t("fields.port") },
    host: { key: "host", label: t("fields.host"), description: t("fields.host") },
    domain: { key: "domain", label: t("fields.domain"), description: t("fields.domain") },
    url: { key: "url", label: "URL", description: t("fields.url") },
    status: { key: "status", label: t("fields.status"), description: t("fields.status") },
    title: { key: "title", label: t("fields.title"), description: t("fields.title") },
    source: { key: "source", label: t("fields.source"), description: t("fields.source") },
    path: { key: "path", label: t("fields.path"), description: t("fields.path") },
    severity: { key: "severity", label: t("fields.severity"), description: t("fields.severity") },
    name: { key: "name", label: t("fields.name"), description: t("fields.name") },
    type: { key: "type", label: t("fields.type"), description: t("fields.type") },
  }
}
...
export function getFieldHistory(field: string): string[] {
  ...
  const history = readJsonStorage<Record<string, string[]>>(FILTER_HISTORY_KEY, {})
...
export function saveFieldHistory(field: string, value: string) {
  ...
  writeJsonStorage(FILTER_HISTORY_KEY, history)
}
