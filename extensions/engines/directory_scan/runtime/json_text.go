...
// validateJSONText rejects source text that encoding/json would silently
// replace. Scanner records stay local until their raw text is losslessly
// decoded into this Engine's typed observation.
